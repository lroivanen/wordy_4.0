...
class MyGUI:
    def __init__(self):
        ...
        # sounds setup
        pygame.mixer.init()
        self.correct_sound = pygame.mixer.Sound("right_letter_sound.wav")
        ...
        self.root.title("Pedro's word game")

        #headline
        self.label = tk.Label(self.root, text="Pedro's wordgame", font=("Arial", 24))
        ...
        self.info_text.insert(tk.END, "Welcome to play Pedro's happy wordgame!")
    ...
    def show_win_popup(self, display):
        ...
        win_popup.geometry("320x310")

        message_label = tk.Label(win_popup, text="Congratulations, you guessed the sentence!")
        ...
        # Load your WebP file using Pillow
